      ...
      <div className="w-full max-w-md">
        <Card className="p-8 border border-border shadow-lg">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="font-bold text-2xl mb-2">Welcome to EnglishTalkAI</h1>
            <p className="text-sm text-muted-foreground">Sign in to start practicing English with AI</p>
          </div>
